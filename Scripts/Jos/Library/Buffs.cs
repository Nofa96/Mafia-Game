...
public class Buffs : MonoBehaviour
{
    ...
    public GameObject parinteBuff;
    public int[] buffsCumparate = new int[13];
    ...
    {
        for (int i = 0; i < bb.nr_ability; i++)
        {
            if (buffsCumparate[i] == 1) parinteBuff.transform.GetChild(i).gameObject.SetActive(a);
            else parinteBuff.transform.GetChild(i).gameObject.SetActive(!a);
        }
    }
    ...
    public void All()
    {
        for (int i = 0; i < bb.nr_ability; i++)
        {
            parinteBuff.transform.GetChild(i).gameObject.SetActive(true);
        }
    }
